...
public extension Promise {
   @discardableResult
   public func then<X>(_ block: @escaping (T) -> X) -> Promise<X> {
   ...
   @discardableResult
   public func registerThen<X>(_ block: @escaping (T) -> X) -> Promise<X> {
      let p = Promise<X>()
      switch state {
   ...
   @discardableResult
   public func then<X>(_ block: @escaping (T) -> Promise<X>) -> Promise<X> {
      tryStartInitialPromiseAndStartIfneeded()
      return registerThen(block)
   }

   @discardableResult
   public func registerThen<X>(_ block: @escaping (T) -> Promise<X>) -> Promise<X> {
         let p = Promise<X>()
         switch state {
         case let .fulfilled(value):
   ...
   @discardableResult
   public func registerThen<X>(_ promise: Promise<X>) -> Promise<X> {
